...
class Netsystemdiantoniopedicini_Commercebug_Block_Html extends Mage_Core_Block_Template
{	
    protected $_config;
    protected function _checkValidScriptPath($scriptPath)
    {
        $paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Netsystemdiantoniopedicini_Commercebug'));
        $valid			= false;
    ...
    {	    	
        $module_dir = Mage::getModuleDir('', 'Netsystemdiantoniopedicini_Commercebug');
    ...
    protected function getConfig()
    {
        ...
        if($shim->isMage2())
        {
            #Netsystemdiantoniopedicini_Commercebug_Model_Shim::Log('Mage 2 Cleanup at: ' . __CLASS__ . ' ' . __LINE__);
