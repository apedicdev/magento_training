...
*/
abstract class Netsystemdiantoniopedicini_Commercebug_Helper_Abstract extends Mage_Core_Helper_Data
{
    protected $_moduleName='Netsystemdiantoniopedicini_Commercebug';
