...
*/
abstract class Netsystemdiantoniopedicini_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Netsystemdiantoniopedicini_Commercebug_AjaxController','Netsystemdiantoniopedicini_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Netsystemdiantoniopedicini_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
