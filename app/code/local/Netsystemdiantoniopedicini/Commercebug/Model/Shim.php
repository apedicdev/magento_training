...
*/
class Netsystemdiantoniopedicini_Commercebug_Model_Shim
{
    ...
    */    
    ...
    protected function _getNamespaceForGroup($group)
    {
        ...
        {
            case 'commercebug':
                $module = 'Netsystemdiantoniopedicini_Commercebug';
    ...
    {
        $full_module_name = 'Netsystemdiantoniopedicini_Commercebug';
    ...
    static public function getInstance()
    {
        if(!self::$_instance)
        {
            self::$_instance = new Netsystemdiantoniopedicini_Commercebug_Model_Shim;
        }
