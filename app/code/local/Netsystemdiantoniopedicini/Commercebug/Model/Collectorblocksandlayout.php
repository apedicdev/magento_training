...
*/
class Netsystemdiantoniopedicini_Commercebug_Model_Collectorblocksandlayout extends Netsystemdiantoniopedicini_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Netsystemdiantoniopedicini_Commercebug') === 0)
            {
                continue;
            }
