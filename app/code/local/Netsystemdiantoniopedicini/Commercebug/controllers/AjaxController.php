...
//weird compiler mode bug
if(class_exists('Netsystemdiantoniopedicini_Commercebug_AjaxController', false)) { return; }

class Netsystemdiantoniopedicini_Commercebug_AjaxController extends Mage_Core_Controller_Front_Action
{   
